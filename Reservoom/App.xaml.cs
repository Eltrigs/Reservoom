...
namespace Reservoom
{
    ...
    {
        /// <summary>
        /// This is basically the first and only place where memory is allocated.
        /// It is done via the "new" keyword and upon calling the constructor other neccessary sections
        /// of memory get allocated in the derivate classes
        /// </summary>
        ...
        public App()
        {
            _host = Host.CreateDefaultBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton((s) => new Hotel("Eltrigs' Hotel", s.GetRequiredService<ReservationBook>()));
        ...
        {
            _host.Start();
            ReservoomDbContextFactory reservoomDbContextFactory = _host.Services.GetService<ReservoomDbContextFactory>();
